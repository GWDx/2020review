...
<<(NotebookDirectory[]<>"mxs\\ZhihuData.mx");
...
rawBilibiliData=Reverse@URLExecute["https://api.bilibili.com/x/relation/followings?vmid="<>"442365922","RawJSON"][["data","list"]];
